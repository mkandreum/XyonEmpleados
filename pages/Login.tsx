    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        {loginLogoUrl ? (
          ...
          <h1 className="text-4xl font-bold tracking-tight text-slate-900 dark:text-white">{companyName}<span className="text-blue-600 dark:text-blue-400">Emp</span></h1>
        )}
        <h2 className="mt-6 text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Portal del Empleado</h2>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className={`block w-full pl-10 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 border bg-white dark:bg-slate-800 text-slate-900 dark:text-white ${isError ? 'border-red-500 text-red-900 dark:text-red-400 placeholder-red-300 focus:ring-red-500 focus:border-red-500' : 'border-slate-300 dark:border-slate-700'} transition-colors`}
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className={`block w-full pl-10 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 border bg-white dark:bg-slate-800 text-slate-900 dark:text-white ${isError ? 'border-red-500 text-red-900 dark:text-red-400 placeholder-red-300 focus:ring-red-500 focus:border-red-500' : 'border-slate-300 dark:border-slate-700'} ${isShaking ? 'animate-shake' : ''} transition-colors`}
                  placeholder="••••••••"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-slate-300 dark:border-slate-700 rounded bg-white dark:bg-slate-800"
                />
