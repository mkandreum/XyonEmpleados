            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-gradient-to-br from-red-500 to-red-600 dark:from-red-600 dark:to-red-700 text-white p-6 rounded-xl shadow-lg transition-all animate-slide-up delay-200">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-3xl font-bold">{benefits?.sickLeaveHoursRemaining || 15}</span>
                    </div>
                    <h3 className="font-semibold mb-1">Horas Baja Médica</h3>
                    <p className="text-red-100 text-sm">Horas disponibles</p>
                </div>
